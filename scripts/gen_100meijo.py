...
faq = [
    ...
    ("100名城スタンプ帳のアプリはありますか？",
     "日本城郭協会の公式スタンプ帳は紙のみで、公式のアプリ版スタンプ帳はありません（2026年7月時点）。スタンプの押印には紙の公式スタンプ帳が必要ですが、登城の記録とメモはアプリで残せます。城道（しろどう／SHIRODO）は無料の城めぐり記録アプリで、紙のスタンプ帳と併用して100名城の登城記録を管理できます。"),
    ...
    ("100名城のスタンプラリーとどう違いますか？",
     "公式スタンプラリーは各城に設置されたスタンプを専用スタンプ帳に集める仕組みです。城道（SHIRODO）はスタンプの代わりに、登城の記録とメモを端末とiCloudに残せるアプリです。スタンプラリーと併用することもできます。"),
    ("スタンプ帳を忘れても記録できますか？",
     "はい。城道（SHIRODO）はスマートフォンだけで登城記録を残せるので、スタンプ帳を忘れた日や、スタンプ設置場所が閉まっていた日でも、その場で記録できます。"),
    ("城めぐりの記録ができるアプリはありますか？",
     "はい。iPhoneなら城道（しろどう／SHIRODO）で、日本100名城の登城記録とメモを無料で残せます（広告なし・アカウント登録不要）。ほかに全国3,000城規模を対象にした位置情報ゲーム型のアプリやWebサービスもあるため、「集めて競う」タイプか「静かに記録する」タイプかで選ぶのがおすすめです。"),
    ("続日本100名城には対応していますか？",
...
<main>
  ...
  <div class="app-callout">
    ...
    <p>城道（しろどう／SHIRODO）は、日本100名城の登城記録とメモを残せる無料iOSアプリ。毎朝ひとつ届く「問い」で、城の文脈を学びながらめぐれます。広告なし・アカウント登録不要。</p>
...
{region_html}
  ...
  <section class="about" id="about">
    ...
    <p class="src-note">出典: <a href="https://jokaku.jp/" target="_blank" rel="noopener">公益財団法人日本城郭協会</a>（日本100名城の選定は2006年、スタンプラリー開始は2007年）。城巡りに必要な装備は<a href="/guide/mochimono/">城巡りの持ち物ガイド</a>、どの城が「登山」になるかは<a href="/guide/level/">登城難易度一覧</a>、記録の残し方は<a href="/guide/kiroku/">登城記録のつけ方</a>にまとめています。</p>
    ...
    <p>ノート・御城印帳・公式スタンプ帳とアプリの違いは、<a href="/guide/kiroku/">登城記録のつけ方</a>で比較しています。</p>
    <a class="back-to-toc" href="#toc">▲ 目次へ戻る</a>
  </section>

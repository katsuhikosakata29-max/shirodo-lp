...
faq = [
    ...
    ("100名城スタンプ帳のアプリはありますか？",
     "日本城郭協会の公式スタンプ帳は紙のみで、公式のアプリ版スタンプ帳はありません（2026年7月時点）。スタンプの押印には紙の公式スタンプ帳が必要ですが、登城日・写真・メモの記録はアプリで残せます。城道（しろどう／SHIRODO）は無料の城めぐり記録アプリで、紙のスタンプ帳と併用して100名城の登城記録を管理できます。"),
    ...
    ("城めぐりの記録ができるアプリはありますか？",
     "はい。iPhoneなら城道（しろどう／SHIRODO）で、日本100名城の登城日・写真・メモを無料で記録できます（広告なし・アカウント登録不要）。ほかに全国3,000城規模を対象にした位置情報ゲーム型のアプリやWebサービスもあるため、「集めて競う」タイプか「静かに記録する」タイプかで選ぶのがおすすめです。"),
    ("続日本100名城には対応していますか？",
...
<main>
  ...
  <div class="app-callout">
    ...
    <p>城道（しろどう／SHIRODO）は、日本100名城の登城記録・メモ・写真を残せる無料iOSアプリ。毎朝ひとつ届く「問い」で、城の文脈を学びながらめぐれます。広告なし・アカウント登録不要。</p>

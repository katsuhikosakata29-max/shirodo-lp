...
{region_html}
  ...
  <section class="about" id="about">
    ...
    <p class="src-note">出典: <a href="https://jokaku.jp/" target="_blank" rel="noopener">公益財団法人日本城郭協会</a>（日本100名城の選定は2006年、スタンプラリー開始は2007年）。城巡りに必要な装備は<a href="/guide/mochimono/">城巡りの持ち物ガイド</a>にまとめています。</p>
